...
AABPawn::AABPawn()
{
	...
	RootComponent = Capsule;//루트 컴포넌트 지정
	...
	Mesh->SetRelativeLocationAndRotation(FVector(0.0f, 0.0f, -88.0f), FRotator(0.0f, -90.f, 0.0f));//좌표계 다른거 보정
...
void AABPawn::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis(TEXT("UpDown"), this, &AABPawn::UpDown);//Updown BindAxis와 함수 UpDown연결
